        ...
        <div className={compact ? '' : 'max-w-4xl mx-auto'}>
            ...
            {showVoiceButton && !renderAsVoicePill && (
              <button
                ...
                className={`flex-shrink-0 flex items-center justify-center transition-all disabled:opacity-50 disabled:cursor-not-allowed group relative overflow-hidden ${
                  compact
                    ? 'h-9 w-9 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white'
            ...
            <div className="flex-grow relative min-w-0">
              <textarea
                ...
                className={`w-full resize-none disabled:opacity-50 transition-colors ${
                  compact
                    ? 'bg-background text-foreground placeholder-muted-foreground/50 rounded-lg border border-border focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none py-2 px-3 text-sm min-h-[52px] max-h-[120px]'
          ...
          {renderAsVoicePill && (
            <button
              onClick={onStartVoice}
              disabled={isLoading}
              className="w-full mt-3 py-2.5 px-4 rounded-full bg-gradient-to-r from-emerald-700 to-emerald-600 hover:from-emerald-600 hover:to-emerald-500 text-white font-medium text-sm flex items-center justify-center gap-2 transition-all hover:scale-[1.01] active:scale-[0.99] disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-emerald-900/20"
            >
