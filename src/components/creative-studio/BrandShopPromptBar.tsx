                ...
                <TooltipTrigger asChild>
                  <button
                    ...
                    className={cn(
                      ...
                      generationType === mode
                        ? 'bg-primary text-primary-foreground shadow-sm shadow-emerald-900/20'
      ...
      {showPromptInput && generationType !== 'conversation' && (
        <div className="flex items-end gap-2 px-3 py-2">
          ...
          {currentOperation === 'generating' ? (
            <span className="relative inline-flex shrink-0 rounded-full p-px text-sm font-bold leading-6 text-emerald-400">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 shrink-0 h-10 px-5 rounded-lg bg-primary text-primary-foreground text-sm font-semibold shadow-md shadow-emerald-900/25 hover:shadow-lg hover:shadow-emerald-900/30 hover:brightness-110 active:brightness-95 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <Send className="w-4 h-4" />
              {generateLabel}
            </button>
