  ...
  return (
    <div className="space-y-6">
      <TabHeroHeader
        ...
        gradientDark="dark:from-emerald-950/40 dark:via-teal-950/40 dark:to-cyan-950/40"
        badgeIcon={<MessageSquare className="h-3.5 w-3.5 text-emerald-600 dark:text-emerald-400" />}
        badgeLabel="Extension Prompts"
        title="Prompt History"
        subtitle="Browse generated prompts from the Chrome extension and promote the best to templates"
      />
