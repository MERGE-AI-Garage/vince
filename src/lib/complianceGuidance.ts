...
export function getInternalUsageGuidance(accessTier: string | null, _clientApprovalRequired?: boolean): ComplianceGuidance {
  ...
  if (tier.includes('Tier 1') || tier.includes('Green')) {
    ...
    return {
      ...
      detail: 'This tool requires legal and compliance review before use. Contact the Vince team if you have a business case.',
    };
  }
  ...
  return {
    ...
    text: 'Pending review - check with Vince',
    detail: 'This tool is under review. Contact the Vince for current status and guidance.',
  };
}
...
export function getClientWorkGuidance(accessTier: string | null, clientApprovalRequired: boolean): ComplianceGuidance {
  ...
  return {
    ...
    detail: 'Guidance pending - consult your account lead and the Vince team before using for client work.',
  };
}
