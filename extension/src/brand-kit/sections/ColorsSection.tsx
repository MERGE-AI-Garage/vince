...
export function ColorsSection() {
  ...
  return (
    <section id="colors" style={{ padding: '20px 16px', borderTop: '1px solid rgba(0,0,0,0.07)' }}>
      <SectionHeading>Color</SectionHeading>
      <p style={{ fontSize: '11px', color: '#6b7280', marginTop: '6px', lineHeight: 1.5, marginBottom: '14px' }}>
        {colors.intro}
      </p>

      {/* Primary Colors */}
      <SectionHeading sub>Primary Colors</SectionHeading>
      <p style={{ fontSize: '11px', color: '#6b7280', marginTop: '4px', marginBottom: '8px', lineHeight: 1.5 }}>
      ...
      <div style={{ marginTop: '20px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
          <div>
            <div style={{ height: '48px', borderRadius: '6px', background: 'linear-gradient(135deg, rgba(139,92,246,0.1) 0%, rgba(139,92,246,0.04) 100%)' }} />
            <p style={{ fontSize: '10px', color: '#6b7280', textAlign: 'center', marginTop: '4px' }}>
              Dark Green Vignette (15-25%) on Warm Gray
            </p>
          </div>
          <div>
            <div style={{ height: '48px', borderRadius: '6px', background: 'linear-gradient(135deg, rgba(139,92,246,0.08) 0%, rgba(139,92,246,0.03) 100%)' }} />
            <p style={{ fontSize: '10px', color: '#6b7280', textAlign: 'center', marginTop: '4px' }}>
              Dark Green to Forest Green
            </p>
          </div>
          <div>
            <div style={{ height: '48px', borderRadius: '6px', background: 'linear-gradient(135deg, rgba(139,92,246,0.05) 0%, rgba(139,92,246,0.15) 100%)' }} />
            <p style={{ fontSize: '10px', color: '#6b7280', textAlign: 'center', marginTop: '4px' }}>
      ...
      <div style={{ marginTop: '20px' }}>
        ...
        <p style={{ fontSize: '11px', color: '#6b7280', marginTop: '6px', lineHeight: 1.5, marginBottom: '10px' }}>
