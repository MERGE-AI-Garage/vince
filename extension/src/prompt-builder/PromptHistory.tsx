            ...
            >
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                  ...
                  <span style={{ fontSize: '9px', color: '#6b7280', opacity: 0.7 }}>
                ...
                <div style={{ display: 'flex', gap: '4px' }}>
                  <button
                    ...
                    style={{
                      ...
                      border: 'none',
                      cursor: 'pointer',
                      color: copiedId === entry.id ? '#8b5cf6' : '#6b7280',
                  ...
                  <button
                    ...
                    onMouseLeave={(e) => { e.currentTarget.style.opacity = '0.3'; e.currentTarget.style.color = '#6b7280'; }}
                  >
                    <Trash2 size={11} />
                  </button>
                </div>
