// ABOUTME: Hero tab that generates on-brand prompts via Gemini + MERGE brand intelligence
...
export function PromptBuilderTab({ detectedPlatform, brandId, brandName, brandColor, brandLogoUrl, isDefaultBrand }: PromptBuilderTabProps) {
  ...
  // Brand-adaptive colors for the prompt builder UI
  const accentDark = brandColor || '#133B34';
  const accentLight = brandColor ? adjustColorSimple(brandColor, 20) : '#00524F';
  const accentMid = brandColor || '#00856C';
  const accentGreen = brandColor ? '#fff' : '#1ED75F';
    ...
    <div style={{ fontFamily: 'Epilogue, system-ui, sans-serif' }}>
          ...
          <div style={{ padding: '14px', background: `linear-gradient(135deg, ${hexToRgba(accentDark, 0.02)} 0%, ${hexToRgba(accentMid, 0.02)} 100%)` }}>
            ...
            {[
              ...
              { step: '3', title: 'Paste into any AI tool', desc: isDefaultBrand
                ? 'Copy the generated prompt into Gemini, NotebookLM, Claude, Adobe Firefly, or any tool in the AI Garage catalog.'
              ...
              <div key={item.step} style={{ display: 'flex', gap: '10px', marginBottom: '10px' }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: '10px', color: '#636466', lineHeight: 1.4, marginTop: '1px' }}>{item.desc}</div>
                </div>
              </div>
            ))}
            ...
            <div style={{ marginTop: '14px', paddingTop: '12px', borderTop: `1px solid ${hexToRgba(accentDark, 0.06)}` }}>
              ...
              <div style={{ fontSize: '10px', color: '#636466', lineHeight: 1.6, marginBottom: '10px' }}>
              ...
              <div style={{
                ...
                {[
                  ...
                  <div key={item.label} style={{
                    ...
                    <div style={{ fontSize: '8px', color: '#636466', lineHeight: 1.3, marginTop: '1px' }}>{item.detail}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div style={{ marginTop: '14px', paddingTop: '12px', borderTop: `1px solid ${hexToRgba(accentDark, 0.06)}` }}>
              ...
              <div style={{ fontSize: '10px', color: '#636466', lineHeight: 1.5 }}>
            ...
            {isDefaultBrand && (
              <div style={{
                ...
                <div style={{ fontSize: '9px', color: '#636466', lineHeight: 1.5 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ fontSize: '9px', fontWeight: 600, color: '#636466', opacity: 0.6, letterSpacing: '0.04em' }}>
        ...
        <div style={{ fontSize: '9px', color: '#636466', opacity: 0.4 }}>
          Brand Lens
        </div>
      </div>
    </div>
